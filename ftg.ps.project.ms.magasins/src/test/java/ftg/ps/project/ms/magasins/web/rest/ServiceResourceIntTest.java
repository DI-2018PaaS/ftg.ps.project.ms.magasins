...
import ftg.ps.project.ms.magasins.repository.ServiceRepository;
...
public class ServiceResourceIntTest {
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.getDesignation()).isEqualTo(DEFAULT_DESIGNATION);
        assertThat(testService.getPrixUnitaire()).isEqualTo(DEFAULT_PRIX_UNITAIRE);
        assertThat(testService.getDescriptionProduit()).isEqualTo(DEFAULT_DESCRIPTION_PRODUIT);
    }
    ...
    public void updateService() throws Exception {
        ...
        assertThat(testService.getDesignation()).isEqualTo(UPDATED_DESIGNATION);
        assertThat(testService.getPrixUnitaire()).isEqualTo(UPDATED_PRIX_UNITAIRE);
        assertThat(testService.getDescriptionProduit()).isEqualTo(UPDATED_DESCRIPTION_PRODUIT);
    }
